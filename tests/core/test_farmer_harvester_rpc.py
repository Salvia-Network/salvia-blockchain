...
from salvia.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from salvia.plotting.manager import PlotManager
from salvia.protocols import farmer_protocol
...
from salvia.rpc.harvester_rpc_client import HarvesterRpcClient
...
from salvia.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xslv"), encode_puzzle_hash(new_ph_2, "xslv"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xslv"))
            ...
            assert config["farmer"]["xslv_target_address"] == encode_puzzle_hash(new_ph, "xslv")
            assert config["pool"]["xslv_target_address"] == encode_puzzle_hash(new_ph_3, "xslv")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xslv")
