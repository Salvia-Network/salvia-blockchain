...
from salvia.wallet.puzzles.p2_conditions import puzzle_for_conditions
from salvia.wallet.puzzles import singleton_top_layer
from salvia.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - salvia.pools.pool_puzzles.py
    - salvia.wallet.puzzles.pool_member_innerpuz.clvm
    - salvia.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("cd712de5a54aa420613d90b4c0f7ad28de3ca1f3edef0ef3fe12d2721c067802")
