...
from salvia.pools.pool_config import PoolWalletConfig
from salvia.util.config import load_config, save_config, create_default_salvia_config
...
def test_pool_config():
    ...
    create_default_salvia_config(test_root, ["config.yaml"])
