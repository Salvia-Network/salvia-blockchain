...
from salvia.wallet.cat_wallet.cat_wallet import CATWallet
from salvia.wallet.trading.offer import Offer
...
class TestCATTrades:
    ...
    async def test_cat_trades(self, wallets_prefarm, trusted):
        ...
        MAKER_SALVIA_BALANCE = 20 * 1000000000000 - 100
        TAKER_SALVIA_BALANCE = 20 * 1000000000000 - 100
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_SALVIA_BALANCE)
        await time_out_assert(15, wallet_taker.get_unconfirmed_balance, TAKER_SALVIA_BALANCE)
        ...
        # salvia_for_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(salvia_for_cat, fee=uint64(1))
        await asyncio.sleep(1)
        ...
        MAKER_SALVIA_BALANCE -= 2  # -1 and -1 for fee
        MAKER_NEW_CAT_BALANCE += 2
        TAKER_SALVIA_BALANCE += 0  # +1 and -1 for fee
        ...
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_SALVIA_BALANCE)
        await time_out_assert(15, wallet_maker.get_unconfirmed_balance, MAKER_SALVIA_BALANCE)
        ...
        await time_out_assert(15, wallet_taker.get_confirmed_balance, TAKER_SALVIA_BALANCE)
        await time_out_assert(15, wallet_taker.get_unconfirmed_balance, TAKER_SALVIA_BALANCE)
        ...
        # cat_for_salvia
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(cat_for_salvia)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_CAT_BALANCE -= 4
        MAKER_SALVIA_BALANCE += 3
        TAKER_CAT_BALANCE += 4
        TAKER_SALVIA_BALANCE -= 3
        ...
        # salvia_for_multiple_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(salvia_for_multiple_cat)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_SALVIA_BALANCE -= 7
        MAKER_CAT_BALANCE += 8
        MAKER_NEW_CAT_BALANCE += 9
        TAKER_SALVIA_BALANCE += 7
        TAKER_CAT_BALANCE -= 8
        ...
        # multiple_cat_for_salvia
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(multiple_cat_for_salvia)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_SALVIA_BALANCE += 10
        TAKER_CAT_BALANCE += 11
        TAKER_NEW_CAT_BALANCE += 12
        TAKER_SALVIA_BALANCE -= 10
        ...
        # salvia_and_cat_for_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(salvia_and_cat_for_cat)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_SALVIA_BALANCE -= 13
        MAKER_CAT_BALANCE -= 14
        MAKER_NEW_CAT_BALANCE += 15
        TAKER_SALVIA_BALANCE += 13
    ...
    async def test_trade_cancellation(self, wallets_prefarm, trusted):
        ...
        MAKER_SALVIA_BALANCE = 20 * 1000000000000 - 100
        MAKER_CAT_BALANCE = 100
        TAKER_SALVIA_BALANCE = 20 * 1000000000000
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_SALVIA_BALANCE)
        ...
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_SALVIA_BALANCE - FEE)
        await time_out_assert(15, cat_wallet_maker.get_confirmed_balance, MAKER_CAT_BALANCE)
        await time_out_assert(15, wallet_taker.get_confirmed_balance, TAKER_SALVIA_BALANCE)
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(salvia_for_cat)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
