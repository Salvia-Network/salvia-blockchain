...
from salvia.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState
...
class TestSimpleSyncProtocol:
    ...
    async def test_subscribe_for_ph(self, wallet_node_simulator):
        ...
        from salvia.wallet.puzzles.singleton_top_layer import SINGLETON_LAUNCHER_HASH
