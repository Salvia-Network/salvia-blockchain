...
wallet_program_files = set(
    [
        ...
        "salvia/wallet/puzzles/p2_delegated_puzzle.clvm",
        "salvia/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "salvia/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "salvia/wallet/puzzles/p2_puzzle_hash.clvm",
        "salvia/wallet/puzzles/rl_aggregation.clvm",
        "salvia/wallet/puzzles/rl.clvm",
        "salvia/wallet/puzzles/sha256tree_module.clvm",
        "salvia/wallet/puzzles/singleton_top_layer.clvm",
        "salvia/wallet/puzzles/did_innerpuz.clvm",
        "salvia/wallet/puzzles/decompress_puzzle.clvm",
        "salvia/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "salvia/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "salvia/wallet/puzzles/block_program_zero.clvm",
        "salvia/wallet/puzzles/test_generator_deserialize.clvm",
        "salvia/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "salvia/wallet/puzzles/p2_singleton.clvm",
        "salvia/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
...
clvm_include_files = set(
    ["salvia/wallet/puzzles/create-lock-puzzlehash.clvm", "salvia/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "salvia/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to salvia/wallet/puzzles, but not added to `wallet_program_files`
        """
