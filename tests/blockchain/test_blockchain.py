...
from salvia.consensus.blockchain import ReceiveBlockResult, Blockchain
from salvia.consensus.coinbase import create_farmer_coin
...
from salvia.types.blockchain_format.foliage import TransactionsInfo
...
from salvia.types.blockchain_format.slots import InfusedChallengeChainSubSlot
...
from salvia.util.ints import uint8, uint64, uint32
...
class TestBodyValidation:
    ...
    async def test_minting_coin(self, empty_blockchain):
        ...
        print("spend=", spend)
        # this create coin will spend all of the coin, so the 10 seeds below
        # will be "minted".
