...
from salvia.daemon.server import pid_path_for_service
...
def launch_service(root_path: Path, service_command) -> Tuple[subprocess.Popen, Path]:
    ...
    print(f"Launching service with SALVIA_ROOT: {os.environ['SALVIA_ROOT']}")
...
if getattr(sys, "frozen", False):
    name_map = {
        ...
        "salvia_seeder_server": "salvia_seeder_server",
    }
