...
from salvia.plotters.plotters import get_available_plotters
...
service_plotter = "salvia_plotter"
...
class WebSocketServer:
        ...
        if ssl.OPENSSL_VERSION_NUMBER < 0x10101000:
            self.log.warning(
                (
                    ...
                    "A future version of Salvia will require TLS1.3."
                ),
                ssl.OPENSSL_VERSION,
            )
        else:
    ...
    def _build_plotting_command_args(self, request: Any, ignoreCount: bool, index: int) -> List[str]:
        ...
        command_args: List[str] = ["salvia", "plotters", plotter]
