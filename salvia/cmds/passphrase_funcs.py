...
from salvia.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Salvia processes will be able to access your keys without prompting for your passphrase."
            )
