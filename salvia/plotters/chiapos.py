"""
NOTE: This contains duplicate code from `salvia.cmds.plots`.
After `salvia plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Salvia Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_salvia(args, root_path):
