...
MASTER_PASSPHRASE_SERVICE_NAME = "Salvia Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Salvia Passphrase"
...
def check_legacy_keyring_keys_present(keyring: Union[MacKeyring, WinKeyring]) -> bool:
    ...
    from salvia.util.keychain import default_keychain_user, default_keychain_service, get_private_key_user, MAX_KEYS
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from salvia.util.keychain import supports_os_passphrase_storage
    ...
    def migrate_legacy_keys(self) -> MigrationResults:
        from salvia.util.keychain import get_private_key_user, Keychain, MAX_KEYS
