...
required to run a [Timelord](https://github.com/Salvia-Network/salvia-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Salvia-Network/salvia-blockchain/blob/main/install-timelord.sh)
